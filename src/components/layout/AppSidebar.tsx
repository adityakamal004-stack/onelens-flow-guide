import { BarChart3, Home, Search, Shield, Bell, Target, Zap, MessageCircle } from "lucide-react";
                  ...
                  <SidebarMenuItem key={item.id}>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start h-12 ${
                        isActive ? "bg-accent/50 text-accent-foreground border-l-2 border-primary" : ""
                      }`}
                    >
